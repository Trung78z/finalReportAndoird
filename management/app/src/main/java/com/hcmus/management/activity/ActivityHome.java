...
public class ActivityHome extends ActivityBase {
	...
	private void searchFoodItems(String query) {
		...
		if (query.equals("burger")) {
			...
			findViewById(R.id.burger).setBackgroundResource(R.drawable.rounded_button_orange);
			findViewById(R.id.taco).setBackgroundResource(0);
		} else {
			for (FoodItem item : originFoodItems) {
			...
			findViewById(R.id.taco).setBackgroundResource(R.drawable.rounded_button_orange);
			findViewById(R.id.burger).setBackgroundResource(0);
		}
		populateCardItems(foodItems);
	}
