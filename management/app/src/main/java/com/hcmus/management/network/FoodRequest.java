...
public class FoodRequest {
	...
	public static void updateFood(Context context, FoodItem item, Callback callback) {
		try {
			RequestQueue requestQueue = Volley.newRequestQueue(context);
			String url = Api.getFoodList + "/" + item.getId(); // Assuming RESTful endpoint: /foods/{id}
